...
export const settingsSchema = z.object({
  ...
  consultation_price_label: z.string().min(1, "Ingresá un nombre").max(80),
  anthropometry_price_label: z.string().min(1, "Ingresá un nombre").max(80),
  booking_combo_label: z.string().min(1, "Ingresá un nombre").max(80),
  booking_show_combined: z.boolean(),
