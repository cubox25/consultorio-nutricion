-- =============================================================================
-- 017_security_followups.sql
-- 1) Restaura allowlist de columnas públicas en system_settings (revierte denylist de 016).
-- 2) Evita filtrar nombre legal del paciente vía DNI en create_public_appointment.
-- =============================================================================

-- --- system_settings: allowlist para anon (alineado a getSystemSettings) ---
...
-- --- RPC booking: misma lógica que 014, sin devolver/guardar nombre de ficha al guest ---
...
BEGIN
  ...
  IF v_patient_id IS NOT NULL THEN
    -- Vincula paciente existente; no expone ni pisa guest_* con el nombre de ficha.
